...
export function VerificationDialog() {
    ...
    return (
        <AlertDialog>
            ...
            <AlertDialogContent
                className="sm:max-w-[425px] w-full flex flex-col justify-center items-center gap-8"
            >
                <Card className="sm:max-w-[425px] w-full mx-auto border-none shadow-none p-0">
                    <CardHeader
                        className="px-0"
                    >
                        <CardTitle className="text-xl font-semibold text-center">Verificar pago</CardTitle>
                    </CardHeader>
                ...
                <AlertDialogFooter
                    className="w-full flex flex-col md:flex-col gap-2 justify-center items-center"
                >
                    <AlertDialogAction
                        className="w-full"
                        disabled={isLoading}
